...
var encodedData = require('soop').load('flappycore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('flappycore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('flappycore/lib/Address', {
